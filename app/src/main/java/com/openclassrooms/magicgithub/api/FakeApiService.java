...
public class FakeApiService implements ApiService {
    ...
    public List<User> getUsers() {
        // TODO: Retourne la liste des utilisateurs
        return users;
    }
    ...
    public void generateRandomUser() {
        // TODO: Génère un utilisateur aléatoire
        Random rand = new Random();
        int index = rand.nextInt(FAKE_USERS_RANDOM.size());
        User randomUser = FAKE_USERS_RANDOM.get(index);
